...
public record GroupInfo(
	[property: JsonPropertyName("name")]      string Name,
	[property: JsonPropertyName("subgroups")] SubgroupInfo[] Subgroups,
	[property: JsonPropertyName("fields")]    FieldInfo[] Fields
);
...
public record NodeInfo(
	...
	[property: JsonPropertyName("attributes")]    JsonElement Attributes,
	[property: JsonPropertyName("functions")]     Dictionary<string, bool> Functions,
	[property: JsonPropertyName("groups")]        GroupInfo[] Groups,
	[property: JsonPropertyName("global_fields")] FieldInfo[] GlobalFields,
