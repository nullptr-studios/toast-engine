...
auto TransformImpl::position() const noexcept -> glm::vec3 {
	return m.position;
}

auto TransformImpl::rotation() const noexcept -> glm::quat {
	return m.rotation;
}

auto TransformImpl::rotationRadians() const noexcept -> glm::vec3 {
	return eulerAngles(m.rotation);
}

auto TransformImpl::rotationDegrees() const noexcept -> glm::vec3 {
	return degrees(eulerAngles(m.rotation));
}

auto TransformImpl::scale() const noexcept -> glm::vec3 {
	return m.scale;
}
...
auto Transform2::position() const noexcept -> glm::vec3 {
	return local.position();
}

auto Transform2::position() noexcept -> glm::vec3& {
	return local.position();
}

auto Transform2::rotation() const noexcept -> glm::quat {
	return local.rotation();
}

auto Transform2::rotation() noexcept -> glm::quat& {
	return local.rotation();
}

auto Transform2::rotationRadians() const noexcept -> glm::vec3 {
	return local.rotationRadians();
}

auto Transform2::rotationDegrees() const noexcept -> glm::vec3 {
	return local.rotationDegrees();
}

auto Transform2::scale() const noexcept -> glm::vec3 {
	return local.scale();
}

auto Transform2::scale() noexcept -> glm::vec3& {
	return local.scale();
}
