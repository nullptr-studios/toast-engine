...
public:
	...
	virtual void OnAnimationEvent(const std::string_view& animationName, int track, const std::string_view& eventName, int intValue, float floatValue, const std::string_view& stringValue);
