 ...
 * @date 30 Jun 2026
 *
 * @brief FMOD VCA for grouping volume control across multiple buses
 */
...
public:
	explicit AudioVca(const toml::table& table, Handle<Schema> schema = {}) : Data(table, std::move(schema)) { }
